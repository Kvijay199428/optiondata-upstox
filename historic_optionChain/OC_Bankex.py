...
#     last_tuesday = last_day - timedelta(days=(last_day.weekday() - 4) % 7)
...
def get_last_tuesday_of_month(year, month, today=None):
    if today is None:
        today = datetime.today()
    ...
    last_tuesday_date = last_day.date()  # Extract the final date
    logging.info(f"Last tuesday of the month is {last_tuesday_date}.")
...
def is_market_open():
    ...
    Market is now considered open tuesday through Saturday during regular hours.
    Returns: bool
    """
